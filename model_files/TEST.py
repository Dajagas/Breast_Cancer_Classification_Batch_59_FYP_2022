...
#get_ipython().run_line_magic('env', 'TF_KERAS = 1')
...
model.load_weights(r'D:\Swaminathan_chellappa_stuff\7th sem\Final Year Project\flask_trial\model_files\vgg_19_p')
